...
export namespace x2.api.certificate.domain.features {
    interface GenerateCertificateFromSessionStateQueryDTO {
        readonly sessionState: ssm.chaincode.dsl.model.SsmSessionStateDTO;
        readonly lang: x2.api.certificate.domain.model.Lang;
    ...
    class GenerateCertificateFromSessionStateQuery implements x2.api.certificate.domain.features.GenerateCertificateFromSessionStateQueryDTO {
        constructor(sessionState: ssm.chaincode.dsl.model.SsmSessionState, lang: x2.api.certificate.domain.model.Lang);
        get sessionState(): ssm.chaincode.dsl.model.SsmSessionState;
        get lang(): x2.api.certificate.domain.model.Lang;
...
export namespace x2.api.certificate.domain.features {
    ...
    class GenerateCertificatePdfQuery implements x2.api.certificate.domain.features.GenerateCertificatePdfQueryDTO {
        constructor(certificate: x2.api.certificate.domain.model.CertificateCredentials, lang: x2.api.certificate.domain.model.Lang);
        get certificate(): x2.api.certificate.domain.model.CertificateCredentials;
        get lang(): x2.api.certificate.domain.model.Lang;
...
export namespace x2.api.certificate.domain.model {
    ...
    class CertificateCredentials implements x2.api.certificate.domain.model.CertificateCredentialsDTO {
        constructor(context: Array<string>, type: Array<string>, id: string, title: x2.api.certificate.domain.model.CertificateData, holder: x2.api.certificate.domain.model.CertificateSigner, issuer: x2.api.certificate.domain.model.CertificateSigner, protocol: x2.api.certificate.domain.model.CertificateProtocol, payload: Array<x2.api.certificate.domain.model.CertificateData>);
        get context(): Array<string>;
        get type(): Array<string>;
        get id(): string;
        get title(): x2.api.certificate.domain.model.CertificateData;
        get holder(): x2.api.certificate.domain.model.CertificateSigner;
        get issuer(): x2.api.certificate.domain.model.CertificateSigner;
        get protocol(): x2.api.certificate.domain.model.CertificateProtocol;
        get payload(): Array<x2.api.certificate.domain.model.CertificateData>;

    }
}
export namespace x2.api.certificate.domain.model {
    interface CertificateDataDTO {
        readonly label: any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */;
        readonly value: any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */;
        readonly unit: any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */;

    }
    class CertificateData implements x2.api.certificate.domain.model.CertificateDataDTO {
        constructor(label: any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */, value: any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */, unit: any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */);
        get label(): any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */;
        get value(): any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */;
        get unit(): any/* kotlin.collections.Map<x2.api.certificate.domain.model.Lang, string> */;
...
export namespace x2.api.certificate.domain.model {
    ...
    class CertificateProtocol implements x2.api.certificate.domain.model.CertificateProtocolDTO {
        constructor(validationProtocol: x2.api.certificate.domain.model.CertificateData, protocolEngineVersion: x2.api.certificate.domain.model.CertificateData, channel: x2.api.certificate.domain.model.CertificateData, session: x2.api.certificate.domain.model.CertificateData, additionals: Array<x2.api.certificate.domain.model.CertificateData>, url: string);
        get validationProtocol(): x2.api.certificate.domain.model.CertificateData;
        get protocolEngineVersion(): x2.api.certificate.domain.model.CertificateData;
        get channel(): x2.api.certificate.domain.model.CertificateData;
        get session(): x2.api.certificate.domain.model.CertificateData;
        get additionals(): Array<x2.api.certificate.domain.model.CertificateData>;
        get url(): string;
...
export namespace x2.api.certificate.domain.model {
    ...
    class CertificateSigner implements x2.api.certificate.domain.model.CertificateSignerDTO {
        constructor(name: x2.api.certificate.domain.model.CertificateData, organization: string, roles: Nullable<string>, signature: string);
        get name(): x2.api.certificate.domain.model.CertificateData;
        get organization(): string;
        get roles(): Nullable<string>;
...
export namespace x2.api.certificate.domain.model {
    abstract class Lang {
        private constructor();
        static get EN(): x2.api.certificate.domain.model.Lang & {
            get name(): "EN";
            get ordinal(): 0;
        };
        static get FR(): x2.api.certificate.domain.model.Lang & {
            get name(): "FR";
            get ordinal(): 1;
        };
        static values(): Array<x2.api.certificate.domain.model.Lang>;
        static valueOf(value: string): x2.api.certificate.domain.model.Lang;
        get name(): "EN" | "FR";
        get ordinal(): 0 | 1;
    }
}
