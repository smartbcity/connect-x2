...
export namespace x2.api.ssm.domain.query {
    interface X2SessionPageQueryDTO {
        ...
        readonly channel: Nullable<kotlin.collections.List<string>>;
        readonly engine: Nullable<kotlin.collections.List<string>>;
        readonly currentStep: Nullable<kotlin.collections.List<number>>;
    }
}
export namespace x2.api.ssm.domain.query {
...
export namespace x2.api.ssm.domain.stats {
    interface StatsResultDTO {
        readonly data: kotlin.collections.List<x2.api.ssm.domain.stats.CellDTO>;
    }
    interface CellDTO {
